...
class FullyConnectedLayer(object):
    ...
    def backward_pass(self, w, delta):
        ...
        # TO BE IMPLEMENTED
        #self.delta =  ...
        # self.delta =  np.dot(self.w.T, delta.T).T * self.a * (1 - self.a)
        self.delta = np.dot(delta, w.T) * self.act.act_der(self.a)
        # self.dw = np.dot(self.a.T, delta)
        # self.dw = np.dot(delta.T, self.a)
